...
public class ElementUtil {
    ...
    @Step("finding Element using by locator: {0}")
    ...
    //Generic method/function that can be use for any mouse hover parent and child menu
    public void handleParentSubMenu(By parentMenu, By subMenu) throws InterruptedException {
        actions.moveToElement(getElement(parentMenu)).build().perform();
        Thread.sleep(2000);
        doClick(subMenu);
    }

    //Generic method/function that can be use for any mouse hover parent and child menu for 4 levels
